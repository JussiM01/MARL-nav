...
if __name__ == '__main__':
    ...
    parser.add_argument('-ep', '--epsilon', type=float, default=0.1, # NOTE: CHANGE THIS LATER?
    ...
    parser.add_argument('-bs', '--batch_size', type=int, default=100, # NOTE: CHANGE THIS LATER?
